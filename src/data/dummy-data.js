...
export const CATEGORIES = [
  new Category('c1', 'Italian', '#ffadad'),
  new Category('c2', 'Quick & Easy', '#ffd6a5'),
  new Category('c3', 'Hamburgers', '#fdffb6'),
  new Category('c4', 'German', '#caffbf'),
  new Category('c5', 'Chicken', '#9bf6ff'),
  new Category('c6', 'Exotic', '#a0c4ff'),
  new Category('c7', 'Japan', '#bdb2ff'),
  new Category('c8', 'French', '#ffc6ff'),
  new Category('c9', 'Rolls', '#ffadad'),
  new Category('c10', 'Summer', '#ffd6a5'),
];
